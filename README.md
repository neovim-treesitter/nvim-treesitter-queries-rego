# nvim-treesitter-queries-rego

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-rego/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-rego/actions/workflows/validate.yml)

Neovim tree-sitter queries for **rego**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-rego",
...
- [ ] Changes are scoped to `rego` — do not include files for other languages
